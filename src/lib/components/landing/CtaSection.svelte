<script lang="ts">
	import BeresInBrand from '$lib/imgs/BeresInBrand.svg';
	import { Bookmark, ChevronRight, Heart, HeartHandshake, Package, Rocket, Users } from 'lucide-svelte';
		...
		<div class="flex w-full flex-col items-center justify-center">
			<div class="relative flex w-full flex-col items-center justify-center overflow-hidden">
				...
				<div class="absolute z-10">
					<div
						class="mx-auto size-24 rounded-[2rem] border flex items-center justify-center bg-white/10 p-3 shadow-2xl backdrop-blur-md dark:bg-black/10 lg:size-32"
					>
						<img
							alt="BeresInBrand"
							src={BeresInBrand}
							class="h-20 w-20 lg:h-24 lg:w-24 px-2 dark:brightness-0 dark:invert"
							width={28}
							height={8}
						/>
					</div>
					<div class="z-10 mt-4 flex flex-col items-center text-center text-primary">
						<h1 class="text-3xl font-bold lg:text-4xl">
							Tidak perlu ragu lagi, publikasikan jasa Anda sekarang!
						</h1>
						<p class="mt-2">
							Dengan fitur boost, pastikan layanan Anda tampil di atas dan mudah ditemukan. Mulai
							percobaan gratis 7 hari Anda tanpa perlu kartu kredit.
						</p>
						<Button
							size="lg"
							variant="outline"
